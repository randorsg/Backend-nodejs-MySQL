...
imagenController.create = async(req, res) => {
    const { nombre, descripcion, eventosId, publico } = req.body;
...
imagenController.searchXeventos = async(req, res) => {
    const { ideventos } = req.params;
    const image = await Image.find({ eventosId: ideventos });
