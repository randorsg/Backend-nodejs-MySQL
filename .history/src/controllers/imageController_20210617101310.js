...
imagenController.create = async(req, res) => {
    const { nombre, descripcion, evntosId, publico } = req.body;
...
imagenController.searchXevntos = async(req, res) => {
    const { idevntos } = req.params;
    const image = await Image.find({ evntosId: idevntos });
